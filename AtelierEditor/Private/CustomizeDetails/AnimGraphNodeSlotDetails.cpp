...
FAnimGraphNodeSlotDetails::FAnimGraphNodeSlotDetails()
{
}
...
void FAnimGraphNodeSlotDetails::CustomizeDetails(class IDetailLayoutBuilder& DetailBuilder)
{
	...
	TSharedPtr<IPropertyHandle> UpdateSourcePoseHandle = DetailBuilder.GetProperty(TEXT("Node.bAlwaysUpdateSourcePose"));
	DetailBuilder.HideProperty(UpdateSourcePoseHandle);
	...
	// create combo box
	IDetailCategoryBuilder& SlotNameGroup = DetailBuilder.EditCategory(TEXT("Config"));
...
FReply FAnimGraphNodeSlotDetails::OnOpenAnimSlotManager()
{
	...
	FGlobalTabmanager::Get()->InvokeTab( FName("SkeletonSlotNames") );
